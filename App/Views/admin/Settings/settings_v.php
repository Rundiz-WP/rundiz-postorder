<div class="wrap">
    ...
    <form id="rd-postorder-settings-form" method="post">
        ...
        <table class="form-table">
            <tbody>
                <tr>
                    <th scope="row"><?php _e('Disable on front pages', 'rundiz-postorder'); ?></th>
                    <td>
                        <label for="disable_customorder_frontpage">
                            ...
                            <?php _e('Disable custom post order on front pages.', 'rundiz-postorder'); ?> 
                        </label>
                        <p class="description"><?php 
                            _e('This included front or home page.', 'rundiz-postorder');
                        ?></p>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><?php _e('Disable on categories', 'rundiz-postorder'); ?></th>
                    <td>
                        <p><?php _e('Please tick on the check box of category you want to disable custom post order.', 'rundiz-postorder'); ?></p>
                        <fieldset>
                            <legend class="screen-reader-text"><?php _e('Disable on categories', 'rundiz-postorder'); ?></legend>
                            <?php
                        ...
                        <p class="description"><?php 
                            _e('This setting affect on both admin and front, or home pages but admin or front pages custom post order must be enabled.', 'rundiz-postorder');
                        ?></p>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><?php _e('Disable on admin pages', 'rundiz-postorder'); ?></th>
                    <td>
                        <label for="disable_customorder_adminpage">
                            ...
                            <?php _e('Disable custom post order on admin pages.', 'rundiz-postorder'); ?> 
                            <?php _e('Please note that this will not disable on admin re-order posts page.', 'rundiz-postorder'); ?> 
                        </label>
                    </td>
                </tr>
            </tbody>
