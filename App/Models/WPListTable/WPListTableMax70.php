 ...
 * 
 * This class is for maximum WordPress v.7.0.
 * 
 * Steps:
 ...
 * 4. Replace class name to `WPListTableMax70` (without back tick `).
 * 5. Add `wp-list-table-max70` to table class inside method `display()`.
 * 6. Run admin page to test that there are no errors.
 * 
 * phpcs:disable
 *
...
namespace RundizPostOrder\App\Models\WPListTable;
...
<p class="search-box">
	...
	public function display() {
		...
		?>
<table class="wp-list-table wp-list-table-max70 <?php echo implode( ' ', $this->get_table_classes() ); ?>">
