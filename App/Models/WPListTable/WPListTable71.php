 ...
 * 
 * This class is for WordPress v.7.1 or newer.
 * 
 * Steps:
 ...
 * 4. Replace class name to `WPListTable71` (without back tick `).
 * 5. Add `wp-list-table-71` to table class inside method `display()`.
...
<p class="search-box">
	...
	public function display() {
		...
		?>
<table class="wp-list-table wp-list-table-71 <?php echo implode( ' ', $this->get_table_classes() ); ?>">
